            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input defaultValue="UseSafe DPC System" />
                </div>
                <div className="space-y-2">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Enable blockchain verification for certificates
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>IoT Integration</Label>
                    <p className="text-sm text-muted-foreground">
                      Enable IoT device data collection
                    </p>
                  </div>
                  <Switch />
                </div>
        ...
        <TabsContent value="workflow">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Automated Document Verification</Label>
                  <p className="text-sm text-muted-foreground">
                    Enable automatic verification for standard documents
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
